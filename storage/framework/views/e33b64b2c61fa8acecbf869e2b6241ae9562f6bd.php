    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                <p class="login-box-msg text-green">Register a new membership</p>
...
unset($__errorArgs, $__bag); ?>"
                            name="name" value="<?php echo e(old('name')); ?>" placeholder="Full name" required autocomplete="name" autofocus>
...
</html><?php /**PATH C:\xampp\htdocs\clearance_data_analytics\resources\views/auth/register.blade.php ENDPATH**/ ?>